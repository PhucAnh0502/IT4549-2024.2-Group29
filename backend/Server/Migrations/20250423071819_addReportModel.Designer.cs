...
namespace Server.Migrations
{
    ...
    [Migration("20250423071819_addReportModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Course.CourseModel", b =>
                {
                    ...
                    b.Property<string>("TrainingDaysString")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Server.Models.Report.ReportModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Models.TrainingRecord.TrainingRecordModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("RegisteredCourseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Models.Report.ReportModel", b =>
                {
                    b.HasOne("Server.Models.User.UserBaseModel", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Server.Models.TrainingRecord.TrainingRecordModel", b =>
                {
                    b.HasOne("Server.Models.Course.RegisteredCourseModel", null)
                        .WithMany()
