        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRequestedTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResetCodes_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RegisteredCourses_Members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegisteredCourses_MemberId",
                table: "RegisteredCourses",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_ResetCodes_AccountId",
                table: "ResetCodes",
                column: "AccountId");
