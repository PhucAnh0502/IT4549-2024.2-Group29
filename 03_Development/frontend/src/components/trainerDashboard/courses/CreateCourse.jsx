  ...
  endTime: form.endTime.length === 5 ? `${form.endTime}:00` : form.endTime,
    ...
    const handleBack = () => {
      if (window.confirm("Bạn có chắc chắn muốn quay lại? Dữ liệu đã nhập sẽ bị mất.")) {
        navigate("/trainer-dashboard/my-courses");
      }
    };
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Điền đầy đủ thông tin để tạo khóa học đào tạo</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {errors.roomName && <p className="mt-1 text-sm text-red-600">{errors.roomName}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      required
                    >
                      {Object.entries(dayTranslations).map(([englishDay, vietnameseDay]) => (
                        <option key={englishDay} value={englishDay} className="py-2">
                          {vietnameseDay} ({englishDay})
                        </option>
                      ))}
                    </select>
                    <p className="text-sm text-gray-500 mt-1">Giữ Ctrl/Cmd để chọn nhiều ngày</p>
                    {errors.trainingDays && <p className="mt-1 text-sm text-red-600">{errors.trainingDays}</p>}
